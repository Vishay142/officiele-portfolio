        ...
        <div class="col-12 mt-3">
            <div class="card">
                ...
                <div class="card-horizontal">
                    <div class="card-body">
                        <h4 class="card-title">Wat is PHP?</h4>
                        <p class="card-text">PHP is een afkorting van “PHP: Hypertext Preprocessor”.
                            Webservers kunnen PHP uitvoeren, waardoor websites dynamisch worden.
                            PHP kan goed communiceren met databases, zoals een MySQL database.
                            Doordat webservers PHP kunnen begrijpen en uitvoeren,
                            wordt PHP ook wel een server-side scripttaal genoemd.<br>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="{{ asset('img/php.png') }}" alt="Card image cap">
                    <div class="carousel-caption d-none d-md-block text-light">
                        <h5>PHP Challenge</h5>
                        <p>Dit is de code van de PHP Challenge.</p>
                    </div>
                </div>
